...
class TestNumberToStringConversion:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("de_CH", 1234.5, "1’234.5"),  # ruff: ignore[ambiguous-unicode-character-string]
...
class TestStringToNumberConversion:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("de_CH", "1’234.5", float, 1234.5),  # ruff: ignore[ambiguous-unicode-character-string]
            ("de_DE", "1.234,5", float, 1234.5),
            ("en_US", "1,234.5", float, 1234.5),
            ("nl_NL", "1.234,5", float, 1234.5),
            ("zh_CN", "1,234.5", float, 1234.5),
            ("de_CH", "1’234", int, 1234),  # ruff: ignore[ambiguous-unicode-character-string]
