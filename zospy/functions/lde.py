...
_APERTURETYPE_USED_SETTINGS = {
    ...
    "Spider": (_APERTURE_X_DECENTER, _APERTURE_Y_DECENTER, _NUMBER_OF_ARMS, _WIDTH_OF_ARMS),
    "RectangularAperture": (_APERTURE_X_DECENTER, _APERTURE_Y_DECENTER, _X_HALF_WIDTH, _Y_HALF_WIDTH),
    "RectangularObscuration": (_APERTURE_X_DECENTER, _APERTURE_Y_DECENTER, _X_HALF_WIDTH, _Y_HALF_WIDTH),
    "EllipticalAperture": (_APERTURE_X_DECENTER, _APERTURE_Y_DECENTER, _X_HALF_WIDTH, _Y_HALF_WIDTH),
    "EllipticalObscuration": (_APERTURE_X_DECENTER, _APERTURE_Y_DECENTER, _X_HALF_WIDTH, _Y_HALF_WIDTH),
