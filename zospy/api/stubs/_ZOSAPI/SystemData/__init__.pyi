...
from zospy.api.stubs._ZOSAPI.Editors import ISolveData, SolveStatus, SolveType
from zospy.api.stubs._ZOSAPI.SystemData import (
    FieldColumn,
...
from zospy.api.stubs._ZOSAPI_constants.SystemData import (
    FieldColumn,
    FieldNormalizationType,
    FieldPattern,
    FieldType,
...
# FieldColumn is imported as constant

# FieldNormalizationType is imported as constant

# FieldPattern is imported as constant

# FieldType is imported as constant

# FNumberComputationType is imported as constant

# HuygensIntegralSettings is imported as constant
...
class IField:
    ...
    def SetPickup(
        self,
        forColumn: FieldColumn,
        fromField: int,
        fromColumn: FieldColumn,
        scale: float,
        offset: float,
    ) -> SolveStatus: ...
    def SetXFixed(self) -> SolveStatus: ...
    def SetXPickup(
        self, fromField: int, fromColumn: FieldColumn, scale: float, offset: float
    ) -> SolveStatus: ...
...
class ISDUnitsData:
    ...
    @property
    def UseLensUnitsForCAD(self) -> bool: ...
    @UseLensUnitsForCAD.setter
    def UseLensUnitsForCAD(self, value: bool) -> None: ...
    @property
    def CADUnits(self) -> ZemaxSystemUnits: ...
    @CADUnits.setter
    def CADUnits(self, value: ZemaxSystemUnits) -> None: ...
...
class IWavelengths:
    ...
    def GaussianQuadrature(
        self, minWave: float, maxWave: float, numSteps: QuadratureSteps
    ) -> bool: ...
...
# ParaxialRaysSetting is imported as constant

# PolarizationMethod is imported as constant

# QuadratureSteps is imported as constant

# RayAimingMethod is imported as constant

# RayAimingType is imported as constant

# ReferenceOPDSetting is imported as constant

# WavelengthPreset is imported as constant

# ZemaxAfocalModeUnits is imported as constant

# ZemaxAnalysisUnits is imported as constant

# ZemaxApertureType is imported as constant

# ZemaxApodizationType is imported as constant

# ZemaxMTFUnits is imported as constant

# ZemaxSourceUnits is imported as constant

# ZemaxSystemUnits is imported as constant

# ZemaxUnitPrefix is imported as constant
