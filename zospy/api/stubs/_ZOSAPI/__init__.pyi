...
from zospy.api.stubs._ZOSAPI import (
    Analysis,
    Common,
    Editors,
    IOpticalSystem,
...
from zospy.api.stubs._ZOSAPI.Analysis import I_Analyses, IMessage, IUserAnalysisData
from zospy.api.stubs._ZOSAPI.Common import IMetadata, ISettingsData, IVectorData
from zospy.api.stubs._ZOSAPI.Editors.LDE import ILensDataEditor
from zospy.api.stubs._ZOSAPI.Editors.MCE import IMultiConfigEditor
from zospy.api.stubs._ZOSAPI.Editors.MFE import IMeritFunctionEditor
from zospy.api.stubs._ZOSAPI.Editors.NCE import INonSeqEditor
from zospy.api.stubs._ZOSAPI.Editors.TDE import IToleranceDataEditor
from zospy.api.stubs._ZOSAPI.Preferences import (
    IPreferencesEditor,
    IPreferencesFolders,
    IPreferencesGeneral,
)
from zospy.api.stubs._ZOSAPI.SystemData import ISystemData
from zospy.api.stubs._ZOSAPI.Tools import IOpticalSystemTools
from zospy.api.stubs._ZOSAPI.Tools.General import IDataDictionary, ZemaxFileTypes
...
class IZOSAPI_Application:
    ...
    def CreateDataFile(
        self, fileName: str, type: ZemaxFileTypes, data1: int, data2: int
    ) -> IDataDictionary: ...
    ...
    def LoadCCallback(
        self, cLib: str, callbackName: str, settings: ISettingsData
    ) -> IZOSAPI_Callback: ...
    def LoadNETCallback(
        self, fromAssembly: str, typeName: str, settings: ISettingsData
    ) -> IZOSAPI_Callback: ...
    def LoadNewSystem(self, LensFile: str) -> IOpticalSystem: ...
    def OpenDataFile(self, fileName: str) -> IDataDictionary: ...
    def RegisterCOperandCallback(
        self, cLib: str, callbackName: str, settings: ISettingsData
    ) -> IMessage: ...
    def RegisterNETOperandCallback(
        self, fromAssembly: str, typeName: str, settings: ISettingsData
    ) -> IMessage: ...
...
class IZOSAPI_Connection:
    ...
    def CreateZemaxServerEx(
        self, applicationName: str, libraryPath: str
    ) -> IZOSAPI_Application: ...
...
# LensUpdateMode is imported as constant

# LicenseStatusType is imported as constant

class OpticalSystemStatusChangedHandler:
    def __init__(self, object: object, method: object): ...
    @property
    def Method(self) -> object: ...
    @property
    def Target(self) -> object: ...
    def BeginInvoke(
        self, systemId: int, newStatus: str, callback: object, object: object
    ) -> object: ...
    def EndInvoke(self, result: object) -> None: ...
    def Invoke(self, systemId: int, newStatus: str) -> None: ...

# SessionModes is imported as constant

# STARUpdateMode is imported as constant

# SystemType is imported as constant

# UpdateStatus is imported as constant

# ZOSAPI_Mode is imported as constant
