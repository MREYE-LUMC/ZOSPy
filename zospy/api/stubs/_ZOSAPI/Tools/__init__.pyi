...
from zospy.api.stubs._ZOSAPI.Tools import (
    HPCNodeSize,
    IAPIUtilities,
    IConvertToNSCGroup,
...
from zospy.api.stubs._ZOSAPI.Tools.FileManager import (
...
from zospy.api.stubs._ZOSAPI.SystemData import ZemaxSystemUnits
...
from zospy.api.stubs._ZOSAPI.Common import IVectorData
...
# CriticalRayType is imported as constant

# HPCEnvironments is imported as constant

# HPCNodeSize is imported as constant

# HPCRunState is imported as constant

class IAPIUtilities:
    def ConvertToStringCust(
        self, x: float, digits: int, expBelow: float, expAbove: float
    ) -> str: ...
    @overload
...
class IFileManager(ISystemTool):
    ...
    def AddAdditionalFile(
        self, knownFolder: KnownFolder, relativePath: str, fileName: str
    ) -> bool: ...
    def GetFile(self, fileNumber: int) -> IFile: ...
    def RemoveAdditionalFile(
        self, project: KnownFolder, relativePath: str, fileName: str
    ) -> bool: ...
    def UseProjectFile(
        self, knownFolder: KnownFolder, relativePath: str, name: str
    ) -> bool: ...
    def UseRootFile(
        self, knownFolder: KnownFolder, relativePath: str, name: str
    ) -> bool: ...
...
class IOpticalSystemTools:
    ...
    def GetHPCSettingsCustom(
        self, nodeCount: int, instanceType: HPCNodeSize
    ) -> IHPCSettings: ...
    ...
    def OpenGlobalOptimization_HPC(
        self, hpcSettings: IHPCSettings
    ) -> IGlobalOptimization: ...
    def OpenHammerOptimization(self) -> IHammerOptimization: ...
    def OpenHammerOptimization_HPC(
        self, hpcSettings: IHPCSettings
    ) -> IHammerOptimization: ...
...
# MaterialFormulas is imported as constant

# MaterialStatuses is imported as constant

# RayPatternOption is imported as constant

# RunStatus is imported as constant

# VertexOrder is imported as constant
