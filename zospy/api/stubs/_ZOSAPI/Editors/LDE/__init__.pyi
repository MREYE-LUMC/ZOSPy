...
from zospy.api.stubs._ZOSAPI.Editors.LDE import (
    CoatingStatusType,
    ConversionOrder,
    ...
    ISTAR_PointWithIndexAndRetardance,
    ISTAR_PointWithRetardance,
    ISTAR_PointWithStress,
...
from zospy.api.stubs._ZOSAPI.Common import (
    ICoordinateTransform,
    IMetadata,
    ZemaxColor,
    ZemaxOpacity,
)
from zospy.api.stubs._ZOSAPI.SystemData import ZemaxApertureType
from zospy.api.stubs._ZOSAPI.Analysis import IMessage

from zospy.api.stubs._ZOSAPI_constants.Editors.LDE import (
    CoatingStatusType,
    ConversionOrder,
    CoordinateConversionResult,
    CoordinateReturnType,
...
# CoatingStatusType is imported as constant

# ConversionOrder is imported as constant

# CoordinateConversionResult is imported as constant

# CoordinateReturnType is imported as constant
...
class ILDEApertureData:
    ...
    def CreateApertureTypeSettings(
        self, type: SurfaceApertureTypes
    ) -> ISurfaceApertureType: ...
...
class ILDEDrawData:
    ...
    @property
    def DrawLocalOriginPoint(self) -> bool: ...
    @DrawLocalOriginPoint.setter
    def DrawLocalOriginPoint(self, value: bool) -> None: ...
    @property
    ...
    @property
    def PntMarkerColor(self) -> ZemaxColor: ...
    @PntMarkerColor.setter
    def PntMarkerColor(self, value: ZemaxColor) -> None: ...
...
class ILDEScatteringData:
    ...
    def ChangeScatteringTypeSettings(
        self, settings: ISurfaceScatteringType
    ) -> bool: ...
    def CreateScatteringTypeSettings(
        self, type: SurfaceScatteringTypes
    ) -> ISurfaceScatteringType: ...
...
class ILensDataEditor(IEditor):
    ...
    def CopySurfaces(
        self, fromSurfaceNumber: int, NumberOfSurfaces: int, toSurfaceNumber: int
    ) -> int: ...
    def CopySurfacesFrom(
        self,
        fromEditor: ILensDataEditor,
        fromSurfaceNumber: int,
    ...
    def GetIndex(
        self, Surface: int, NumberOfWavelengths: int
    ...
    def RunTool_AddCoatingsToAllSurfaces(
        self, settings: ILDETool_AddCoatingsToAllSurfaces
    ) -> None: ...
    def RunTool_AddFoldMirror(
        self, Surface: int, tilt: TiltType, reflectAngle: float
    ) -> IMessage: ...
    ...
    def RunTool_ReverseElements(
        self, firstSurface: int, lastSurface: int
    ) -> IMessage: ...
    def RunTool_TiltDecenterElements(
        self, settings: ILDETool_TiltDecenterElements
    ) -> IMessage: ...
    def SetLabel(self, Surface: int, label: int) -> bool: ...
    def ShowLDE(self) -> bool: ...

# IndexDataType is imported as constant

# InterpolationMethod is imported as constant
...
class ISTAR_CoordinateTransform:
    ...
    def ConvertAnglesToRotationMatrix(
        self, thetaX: float, thetaY: float, thetaZ: float
    ) -> list[list[float]]: ...
...
class ISTAR_DeformationsFEAData:
    ...
    def GetFEAPointsWithAutoWeightsSafe(
        self, weightVariation: int
    ) -> list[ISTAR_PointWithDeformationAndWeight]: ...
    def GetTransformedFEAPointsNoImportRequired(
        self,
        filename: str,
        adaptCase: int,
        adapterR: list[list[float]],
        adapterO: list[float],
        coordinateOption: int,
    ) -> list[ISTAR_PointWithDeformation]: ...
    def GetTransformedFEAPointsSafe(
        self, coordinateOption: int
    ) -> list[ISTAR_PointWithDeformation]: ...
...
class ISTAR_PointWithIndexAndRetardance:
    @property
    def X(self) -> float: ...
    @X.setter
    def X(self, value: float) -> None: ...
    ...
    @Retardance.setter
    def Retardance(self, value: float) -> None: ...

class ISTAR_PointWithRetardance:
    @property
    def X(self) -> float: ...
    @X.setter
    def X(self, value: float) -> None: ...
...
class ISTAR_PointWithStress:
    ...
    def Sxx(self) -> float: ...
    @Sxx.setter
    def Sxx(self, value: float) -> None: ...
    @property
    def Syy(self) -> float: ...
    @Syy.setter
    def Syy(self, value: float) -> None: ...
    @property
    def Szz(self) -> float: ...
    @Szz.setter
    def Szz(self, value: float) -> None: ...
    @property
    def Sxy(self) -> float: ...
    @Sxy.setter
...
class ISTAR_Stress:
    ...
    def GRINStep(self, value: float) -> None: ...
    @property
    def FEAData(self) -> ISTAR_StressFEAData: ...
    @property
    def Fits(self) -> ISTAR_StressFits: ...
    @property
    def CoordinateTransform(self) -> ISTAR_CoordinateTransform: ...
    def GetWorkingWavelength(self) -> int: ...
    def IsDataLocalCS(self) -> bool: ...
    def IsPropagationLinear(self) -> bool: ...
    def SetDataIsGlobal(self) -> None: ...
    def SetDataIsLocal(self) -> None: ...
    def SetPropagationLinear(self, linear: bool) -> None: ...
    def SetWorkingWavelength(self, wavelength_number: int) -> None: ...

class ISTAR_StressFEAData:
    @property
    def SurfaceNumber(self) -> int: ...
    @property
    def NumberOfDataPoints(self) -> int: ...
    ...
    def Filename(self) -> str: ...
    @property
    def IsStressImported(self) -> bool: ...
    def GetFEAPointsSafe(self) -> list[ISTAR_PointWithStress]: ...
    def GetTransformedFEAPointsNoImportRequired(
        self,
        filename: str,
        adaptCase: int,
        ...
        adapterO: list[float],
        coordinateOption: int,
    ) -> list[ISTAR_PointWithStress]: ...
    def GetTransformedFEAPointsSafe(
        self, coordinateOption: int
    ) -> list[ISTAR_PointWithStress]: ...
    def GetTransformValues(self, transformType: int) -> ICoordinateTransform: ...
    def ImportStress(self, filename: str) -> None: ...
    def IsStressTensorApplied(self) -> bool: ...
    def UnloadData(self) -> None: ...

class ISTAR_StressFits:
    @property
    def SurfaceNumber(self) -> int: ...
    @property
    def GRINStep(self) -> float: ...
    ...
    def Settings(self) -> ISTAR_FEAFitSettings: ...
    @property
    def FitResultsStressXX(self) -> ISTAR_FEAFitResults: ...
    @property
    def FitResultsStressYY(self) -> ISTAR_FEAFitResults: ...
    @property
    def FitResultsStressZZ(self) -> ISTAR_FEAFitResults: ...
    @property
    def FitResultsStressXY(self) -> ISTAR_FEAFitResults: ...
    @property
    def FitResultsStressYZ(self) -> ISTAR_FEAFitResults: ...
    @property
    def FitResultsStressXZ(self) -> ISTAR_FEAFitResults: ...
    def ApplyStress(self) -> None: ...
    def GetFittedIndex(
        self, X: float, Y: float, Z: float, L: float, M: float, N: float
    ) -> float: ...
    def GetFittedRotatedStressTensor(
        self, X: float, Y: float, Z: float, L: float, M: float, N: float
    ) -> list[float]: ...
    def GetFittedStressTensor(self, X: float, Y: float, Z: float) -> list[float]: ...
    def GetPointRetardanceList(
        self, density: int, coordinateOption: int, field: int
    ) -> list[ISTAR_PointWithIndexAndRetardance]: ...
    def GetRetardance(
        self, X: float, Y: float, Z: float, L: float, M: float, N: float, Step: float
    ) -> float: ...
    def GetRetardanceMap(
        self,
        density: int,
        coordinateOption: int,
        field: int,
        ...
        phix: float,
        phiy: float,
    ) -> list[ISTAR_PointWithRetardance]: ...
    def ListFittedStressTensor(
        self, xs: list[float], ys: list[float], zs: list[float]
    ) -> list[ISTAR_PointWithStress]: ...
    def Refit(self) -> None: ...
    def RemoveStress(self) -> None: ...
...
class ISurfaceBinary2(
    ISurfaceCoeff_P_NthEvenPower, ISurface, ISurfaceNthEvenOrderTerms
):
    @property
    def DiffractOrderCell(self) -> IEditorCell: ...
    @property
...
class ISurfaceBinary4(ISurface):
    ...
    def SetAsphereInZone_P_NthEvenPower(
        self, zoneN: int, n: int, Value: float
    ) -> None: ...
    def SetConicInZone(self, zoneN: int, Value: float) -> None: ...
    def SetOrderInZone(self, zoneN: int, Value: float) -> None: ...
    def SetPhaseInZone_P_NthEvenPower(
        self, zoneN: int, n: int, Value: float
    ) -> None: ...
...
class ISurfaceCylinderFrensel(
    ISurface, ISurfaceNthEvenOrderTerms, ISurfaceCoeff_Y_NthEvenPower
):
    @property
...
class ISurfaceExtendedFresnel(
    ISurface, ISurfaceNthEvenOrderTerms, ISurfaceCoeff_R_NthEvenPower
):
    @property
    def CurvatureCell(self) -> IEditorCell: ...
    @property
...
class ISurfaceExtendedToroidalGrating(
    ISurfaceXYPolynomial, ISurface, ISurfaceNthEvenOrderTerms
):
    @property
    def RadiusOfRotationCell(self) -> IEditorCell: ...
    @property
...
class ISurfaceGeneralizedFresnel(
    ISurfaceXYPolynomial, ISurface, ISurfaceNthEvenOrderTerms
):
    @property
    def NormRadiusCell(self) -> IEditorCell: ...
...
class ISurfacePolynomial(
    ISurfaceCoeff_X_NthEvenPower_8, ISurface, ISurfaceCoeff_Y_NthEvenPower_8
): ...
...
class ISurfaceRadialGrating(
    ISurfaceNthEvenOrderTerms, ISurface, ISurfaceCoeff_P_NthPower
):
    @property
...
class ISurfaceZernikeStandardSag(
    ISurfaceNthZernike, ISurface, ISurfaceNthEvenOrderTerms
):
    @property
    def ExtrapolateCell(self) -> IEditorCell: ...
    @property
...
# NodesDataType is imported as constant

# PilotRadiusMode is imported as constant

# PointCloudFileFormat is imported as constant

# PupilApodizationType is imported as constant

# QTypes is imported as constant

# STARDeformationOption is imported as constant

# SubstrateType is imported as constant

# SurfaceApertureTypes is imported as constant

# SurfaceColumn is imported as constant

# SurfaceEdgeDraw is imported as constant

# SurfaceScatteringTypes is imported as constant

# SurfaceType is imported as constant

# TiltDecenterOrderType is imported as constant

# TiltDecenterPickupType is imported as constant

# TiltType is imported as constant

# XYSampling is imported as constant
