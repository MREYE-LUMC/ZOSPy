...
from zospy.api.stubs._ZOSAPI_constants.Wizards import (
    CriterionTypes,
    DefaultAndDegrees,
    DefaultAndFringes,
    OptimizationTypes,
...
# CriterionTypes is imported as constant

# DefaultAndDegrees is imported as constant

# DefaultAndFringes is imported as constant
...
class IImageData:
    ...
    def GetPixelsSafe(
        self, totalSize: int, height: int, width: int
    ) -> tuple[list[int]]: ...
...
class IToleranceWizard(IWizard):
    ...
    def SelectTolerancePreset(
        self, vendor: ToleranceVendor, grade: ToleranceGrade
    ) -> None: ...
...
# OptimizationTypes is imported as constant

# PupilArmsCount is imported as constant

# ReferenceTypes is imported as constant

# ToleranceGrade is imported as constant

# ToleranceVendor is imported as constant

# WizardType is imported as constant
