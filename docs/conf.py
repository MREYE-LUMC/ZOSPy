...
myst_substitutions = {
    ...
    "i_check": "{fa}`circle-check;sd-text-success`",
    "i_info": "{fa}`circle-info;sd-text-info`",
    "i_alert": "{fa}`triangle-exclamation;sd-text-warning`",
    "i_cross": "{fa}`circle-xmark;sd-text-danger`",
}
